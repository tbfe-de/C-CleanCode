...
void DDD_HH_MM_SS_Init(DDD_HH_MM_SS* self) {
...
void DDD_HH_MM_SS_update(DDD_HH_MM_SS* self) {
	const size_t n_avail = sizeof self->display_;
	const size_t n_used = snprintf(self->display_, n_avail,
									"%3dd%02dh%02dm%02ds",
									self->days_.value_,
									self->hours_.value_,
...
const char* DDD_HH_MM_SS_display(const DDD_HH_MM_SS* self) {
